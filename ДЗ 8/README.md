...
Создание заказа с участием **Billing**, **Warehouse** и **Delivery**; при ошибке на шагах после оплаты — **откат** уже выполненных действий. Код: [HwApp](../HwApp/). Теория, диаграммы и IDL: [Архитектура/README.md](./Архитектура/README.md). Развёртывание: [K8s](./K8s/). Проверка сценария: [Postman](./Postman/).

| Раздел задания | Куда смотреть |
|----------------|---------------|
| **0)** какой паттерн использован, схема, IDL | [Архитектура/README.md](./Архитектура/README.md) — три документа: обзор вариантов, аргументация выбора, подробное описание реализации |
