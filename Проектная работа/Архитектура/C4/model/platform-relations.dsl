customer -> onlineStore.apiGateway "Вызывает public API магазина" "HTTPS/JSON"
administrator -> onlineStore.apiGateway "Вызывает административный public API" "HTTPS/JSON"
