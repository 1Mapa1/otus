...
using WarehouseService.Api.Authentication;
using WarehouseService.Api.Observability;
...
try
{
    ...
    if (app.Environment.IsDevelopment())
    {
        app.UseSwagger(c =>
        {
            c.RouteTemplate = "api/warehouse/swagger/{documentName}/swagger.json";
        });

        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/api/warehouse/swagger/v1/swagger.json", "Warehouse API V1");
            c.RoutePrefix = "api/warehouse/swagger";
        });
    }
