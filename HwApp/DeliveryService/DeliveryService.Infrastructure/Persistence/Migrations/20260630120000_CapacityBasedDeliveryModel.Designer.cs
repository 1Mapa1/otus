...
namespace DeliveryService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260630120000_CapacityBasedDeliveryModel")]
    partial class CapacityBasedDeliveryModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeliveryService.Domain.Slots.DeliverySlot", b =>
                {
                    ...
                    b.ToTable("delivery_slot", null, t =>
                        {
                            t.HasCheckConstraint("CK_delivery_slot_capacity", "capacity > 0");

                            t.HasCheckConstraint("CK_delivery_slot_reserved_capacity", "reserved_count <= capacity");

                            t.HasCheckConstraint("CK_delivery_slot_reserved_count", "reserved_count >= 0");
                        });
                });
