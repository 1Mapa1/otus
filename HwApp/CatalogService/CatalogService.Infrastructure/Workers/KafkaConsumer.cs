    ...
    internal sealed class KafkaConsumer : BackgroundService
    {
        ...
        private async Task ConsumeLoopAsync(CancellationToken stoppingToken)
        {
            ...
            _logger.LogInformation(
                "Catalog Kafka consumer started. GroupId: {GroupId}. Topics: {Topics}",
                _options.GroupId,
            ...
            try
            {
                while (!stoppingToken.IsCancellationRequested)
                {
                    ...
                    try
                    {
                        ...
                        var processor = scope.ServiceProvider.GetRequiredService<StockChangedProcessor>();
                    ...
                    {
                        _logger.LogError(ex, "Failed to process Kafka message. Offset will not be committed.");
                    }
                }
            }
            finally
