...
Реализация: **OrderService** (обработчик `POST /api/orders`, сервис идемпотентности, репозиторий записей, конфигурация `Idempotency`). Кратко по сервису: [OrderService/README](../../HwApp/OrderService/README.md).